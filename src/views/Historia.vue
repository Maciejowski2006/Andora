<template>
	<main>
		...
		<article>
			...
			<p>Do 1993 była państwem nie posiadającym suwerenności prawno-międzynarodowej, pod wspólnym zwierzchnictwem współksiążąt którzy reprezentowali ją w stosunkach międzynarodowych, gwarantowali jej bezpieczeństwo i sprawowali najwyższą władzę ustawodawczą i wykonawczą poprzez swych przedstawicieli, oraz stałych delegatów.</p>
			<p>Jednak zapoczątkowany w latach pięćdziesiątych rozkwit turystyki, handlu, oraz rozwój transportu przyczyniły się do ewolucji kraju w którym dotychczas przeważało rolnictwo. Rozpoczęła się modernizacja struktur politycznych. W latach siedemdziesiątych rozpoczęto gruntowne reformy.</p>
			<p>Stopniowo wprowadzono powszechne prawo wyborcze do Rady Generalnej, będącej zgromadzeniem reprezentantów gmin pomimo formalnego zakazu istnienia partii politycznych. W 1979 roku powstała Demokratyczna Partia Andory, dążąca do modernizacji gospodarki i ustroju politycznego kraju.Po zaleceniach Unii Europejskiej w 1990 Rada Generalna powołała komisję do opracowania konstytucji.</p>
			<p>Rok później współksiążęta Andory wyrazili zgodę na ograniczenie swych uprawnień i uznanie suwerenności narodu. W referendum powszechnym z 1993 obywatele zatwierdzili pierwszą w historii kraju konstytucję[3]. Od 1993 Andora jest członkiem ONZ, natomiast od 1994 rządy sprawują nieprzerwanie liberałowie.</p>
			<p>Andora co prawda nie należy do Unii Europejskiej, ale w lutym 2002 roku wraz z Francją i Hiszpanią przyjęła euro jako obowiązującą w kraju walutę.</p>
			<p>Andorskie liberalne regulacje w sprawach bankowości i finansów, przyciągające obce kapitały, ale także umożliwiające zamożnym obcokrajowcom unikanie opodatkowania, były przedmiotem krytyki organizacji międzynarodowych - Organizacji Współpracy Gospodarczej i Rozwoju (OECD), jak i Międzynarodowego Funduszu Walutowego.</p>
		</article>
	</main>
</template>
